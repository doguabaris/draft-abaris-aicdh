...
|---------------|--------|-----------------------------------------------------|
| `mode`        | Token  | Indicates AI involvement: `none`, `partial`, `full` |
...
| `date`        | Date   | Generation timestamp (RFC9651 Date format)          |
...
|:-----------|:----------------------------------------------------------------------------|
| `none`     | Indicates that AI was not used.                                             |
| `full`     | Indicates the entire content was generated by AI.                           |
| `partial`  | Indicates AI was used for parts of the content or assisted in its creation. |
...
**Note:** The `AI-Disclosure` header applies to the entire content of the HTTP response payload. The `mode=partial` value indicates that AI was involved somewhere in the content or its creation process, but this header does not provide information about specific locations or the exact nature of the partial involvement. For expressing provenance information about specific parts of a resource, more comprehensive mechanisms such as C2PA [C2PA-Spec] should be used.
